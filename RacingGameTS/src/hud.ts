...
export class HUD {
    ...
    private readonly HUDMenu: HTMLDivElement;
    private readonly hpContainer: HTMLDivElement;
    private readonly stageLabelElement: HTMLDivElement;
    private readonly stageLevelElement: HTMLDivElement;
    private readonly scoreElement: HTMLDivElement;
    private readonly scoreMultiplierElement: HTMLDivElement;

    constructor(private gameBrain: GameBrain) {
